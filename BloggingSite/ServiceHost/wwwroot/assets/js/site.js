...
jQuery.validator.addMethod("fileExtentionLimit",
    function (value, element, params) {
        var extentions = ["image/jpeg", "image/png", "image/jpg"];
        var fileFormat = element.files[0].type;
        if (fileFormat != extentions[0] && fileFormat != extentions[1] && fileFormat != extentions[2])
            return false;
        else {
            return true;
        }
